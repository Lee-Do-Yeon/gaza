                    ...
                    <div class="news_detail_wrapper">
                        ...
                        <div class="download_pdf_area">
                            ...
                            <div class="downloads_pdf_button">
                                <button class="btn btn_theme btn_md">Download pdf</button>
                            </div>
                        </div>
                        ...
                        <div class="news_details_right_item">
                            ...
                            <div class="recent_news_item">
                                ...
                                <div class="recent_news_text">
                                    <h5><router-link to="/news-details">Ea exercitation qui nostrud sint labore irure in
                                            exercitation</router-link></h5>
                            ...
                            <div class="recent_news_item">
                                ...
                                <div class="recent_news_text">
                                    <h5><router-link to="/news-details">Amet cupidatat aliqua dolor del proident veniam
                                            proident</router-link></h5>
                                    <p><router-link to="/news">26 Oct 2021</router-link> <i class="fas fa-circle"></i> 8 min read</p>
                                </div>
                            </div>
                            <div class="recent_news_item">
                                ...
                                <div class="recent_news_text">
                                    <h5><router-link to="/news-details">Consequat enim aute sint sint ad et culpa eu
                                            magna</router-link></h5>
                                    <p><router-link to="/news">26 Oct 2021</router-link> <i class="fas fa-circle"></i> 8 min read</p>
                                </div>
                            </div>
                            <div class="recent_news_item">
                                ...
                                <div class="recent_news_text">
                                    <h5><router-link to="/news-details">Proident dolore dolore cillum pelo aliquip irure
                                            elit</router-link></h5>
                                    <p><router-link to="/news">26 Oct 2021</router-link> <i class="fas fa-circle"></i> 8 min read</p>
                                </div>
                            </div>
