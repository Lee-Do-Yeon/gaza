                    ...
                    <div class="promotional_tour_slider owl-theme owl-carousel dot_style">
                        <swiper :slides-per-view="4" :space-between="20"  
                            ...
                            <swiper-slide>
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <router-link to="/hotel-details"><img src="../../assets/img/tab-img/hotel1.png"
                                                alt="img"></router-link>
                            ...
                            <swiper-slide>
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <router-link to="/hotel-details"><img src="../../assets/img/tab-img/hotel2.png"
                                                alt="img"></router-link>
                                    ...
                                    <div class="theme_two_box_content">
                                        <h4><router-link to="/hotel-details">Hotel paradise international</router-link>
                                        </h4>
                                        <p><span class="review_rating">4.8/5 Excellent</span> <span
                                                class="review_count">(1214
                                                reviewes)</span></p>
                            ...
                            <swiper-slide>
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <router-link to="/hotel-details"><img src="../../assets/img/tab-img/hotel3.png"
                                                alt="img"></router-link>
                            ...
                            <swiper-slide>
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <router-link to="/hotel-details"><img src="../../assets/img/tab-img/hotel4.png"
                                                alt="img"></router-link>
                            ...
                            <swiper-slide>
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <router-link to="/hotel-details"><img src="../../assets/img/tab-img/hotel6.png"
                                                alt="img"></router-link>
                            ...
                            <swiper-slide>
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <router-link to="/hotel-details"><img src="../../assets/img/tab-img/hotel7.png"
                                                alt="img"></router-link>
