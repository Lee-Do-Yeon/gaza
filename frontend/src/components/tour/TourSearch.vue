                            ...
                            <div class="theme_common_box_two img_hover">
                                <div class="theme_two_box_img">
                                    <router-link to="/tour-details">
                                        <img :src="require(`@/assets/img/tab-img/${tourInfo.tourImage}.png`)"
                                            alt="{{ tourInfo.altText }}" />
                                    </router-link>
                                    <p><i class="fas fa-map-marker-alt"></i>{{ tourInfo.location }}</p>
                                </div>
                                <div class="theme_two_box_content">
                                    <h4><router-link to="/tour-details">{{ tourInfo.tourTitle }}</router-link></h4>
