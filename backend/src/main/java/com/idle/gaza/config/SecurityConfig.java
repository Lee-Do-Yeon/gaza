...
import com.idle.gaza.config.filter.CustomAuthenticationFilter;
import com.idle.gaza.config.filter.JwtAuthorizationFilter;
import com.idle.gaza.config.handler.CustomAuthFailureHandler;
import com.idle.gaza.config.handler.CustomAuthSuccessHandler;
import com.idle.gaza.config.handler.CustomAuthenticationProvider;
...
class SecurityConfig {
    ...
    public CustomAuthenticationFilter customAuthenticationFilter() {
        ...
        customAuthenticationFilter.setFilterProcessesUrl("/users/login");     // 접근 URL
